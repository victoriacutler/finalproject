...
accessissue1 [label = 'high upfront cost', fillcolor = Beige]
accessissue2 [label = 'on an opt in basis', fillcolor = Beige]
accessissue3 [label = 'less renter autonomy', fillcolor = Beige]
lessaccess [label =  'less acccess for \n low income households']
results [label= 'missed monetary \n savings']
...
## Equity Issues Part 2
### More Cost Shifts to Those Without Solar
```{r, echo = FALSE}
library(DiagrammeR)
DiagrammeR::grViz("digraph {
